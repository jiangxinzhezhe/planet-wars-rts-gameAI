...
class SmartGreedyAgent : PlanetWarsPlayer() {
    ...
    override fun getAction(gameState: GameState): Action {
        ...
        // 1️⃣ --- Check if any planet is under threat ---
        val threatened = myPlanets.firstOrNull { planet ->
        ...
        if (threatened != null) {
            val reinforcements = myPlanets
                .filter { it != threatened && it.nShips > 15 }
                .minByOrNull { distance(it.position, threatened.position) }
